...
掲載ニュースのタイトル、注釈、用途領域、企業、プログラム、機体、世界モデル、シミュレータ、技術を横断検索できます。
...
<input type="search" id="search-box" placeholder="キーワードを入力（例: CCA、world-model、CARLA、Sim-to-Real）" autofocus>
