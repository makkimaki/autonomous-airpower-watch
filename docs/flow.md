...
(function () {
  ...
  function show(title,ids,articles){var by={};articles.forEach(function(a){by[a.id]=a;});detail.innerHTML='<h2>'+esc(title)+'</h2><ul>'+ids.map(function(id){var a=by[id];return '<li><a href="'+esc(a.url)+'">'+esc(a.title)+'</a><br><small>'+esc(a.date)+' — '+esc(a.summary)+'</small></li>';}).join('')+'</ul>';}
